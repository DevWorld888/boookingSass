...
export default function NewServiceDialog({ orgId }: { orgId: string }) {
  ...
  return (
    <>
      <button 
        className="inline-flex items-center px-4 py-2 bg-[#1C2438] text-white font-medium rounded-lg hover:from-blue-700 hover:to-purple-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 shadow-lg hover:shadow-xl"
